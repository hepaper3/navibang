"""
Django settings for navibang project.
...
WSGI_APPLICATION = 'navibang.wsgi.application'
...
STATICFILES_DIRS = [ os.path.join(BASE_DIR, 'bangregister', 'static') 
] #어디있는지
STATIC_ROOT = os.path.join(BASE_DIR, 'static') #어디로 모일건지
STATIC_URL = '/static/'
